    ...
    <div className="space-y-6">
      ...
      <div className="text-center py-4 sm:py-6">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-2">
          🏏 IPL 2026 <span className="gradient-text">Playoff Lab</span>
        </h1>
        <p className="text-sm text-muted">
          Standings, Monte Carlo playoff odds, and simulators — The Stands&apos; cricket engine.
        </p>
        ...
        <div className="flex items-center justify-center gap-1.5 mt-4 flex-wrap">
          {[
            ...
            <Link
              key={href}
              href={href}
              className="text-xs px-3 py-1.5 rounded-lg border transition-colors text-muted hover:text-primary"
